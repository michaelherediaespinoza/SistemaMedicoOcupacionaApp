...
@Component({
  selector: 'app-add-consulta-preocupacional',
  templateUrl: './add-consulta-preocupacional.component.html',
  styleUrls: ['./add-consulta-preocupacional.component.css']
})
export class AddConsultaPreocupacionalComponent implements OnInit {

  @ViewChild("addconsultapreocupacionalfocus") addconsultapreocupacionalfocus: ElementRef;
  ...
  ngOnInit(): void {
    this.titulo = "REGISTRAR CONSULTA PREOCUPACIONAL";
  ...
  ngAfterViewInit() {
    this.addconsultapreocupacionalfocus.nativeElement.focus();
  }
  ...
  saveOrEditCP(): void {
    ...
    if (this.banderaEditcp == "true") {
      this.titulo = "ACTUALIZAR CONSULTA PREOCUPACIONAL";
  ...
  guardarconsultaPreocupacional(): void {
    this.saveExamenLaboratorio();
    console.log("Inser Paceinte: " + this.paciente.nombre)
    this.consultaPreocupacional.paciente = this.paciente;
    console.log("Insertado Paceinte 002: " + this.consultaPreocupacional.paciente)
    this.consultaPreocupacional.diagnostico = this.diagnostico;
    this.consultaPreocupacional.examenFisico = this.examenFisico;
    this.consultaPreocupacional.examenLaboratorio = this.examenLaboratorio;
    this.consultaPreocupacional.electrocardiograma = this.electrocardiograma;
    this.consultaPreocupacional.espirometria = this.espirometria;
    this.consultaPreocupacional.audiometria = this.audiometria;
    this.consultaPreocupacional.radiologia = this.radiologia

    this.consultaPreocupacional.revisionActual = this.revisionActual;
    this.consultaPreocupacional.examenGeneral = this.examenGeneralAdd;
    ...
    this.consultaPreocupacional.factorRiesgoPuestoTrabajo = this.factorRiesgoPuestoTrabajo;


    this.service.createConsultaPreocupacional(this.consultaPreocupacional)
      .subscribe(data => {
  ...
  editarConsulta(): void {
    ...
    let codigoPaciente = localStorage.getItem('codigoPaciente');
    console.log("codigo Paciente " + codigoPaciente);
    this.codigoconsultaPreocupacional = Number(codigoCP);
    this.codigoPaciente = Number(codigoPaciente);
    console.log("codigo Consulta preocupacional: " + codigoPaciente);
  ...
  */
  ...
  openDialogDiagnostico(): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      for (let diagnostic of this.diagnosticoSelect) {
        ...
        this.consultaPreocupacional.diagnosticoCie = this.auxDiagnosticoGeneral

        this.consultaPreocupacional.diagnosticoCie = this.auxDiagnosrtico1 + "\n" + this.auxDiagnosrtico2 +
  ...
  calculoIndiceMasaCorporal() {
    this.peso = this.consultaPreocupacional.peso;
    this.talla = this.consultaPreocupacional.talla;

    this.consultaPreocupacional.masaCorporal = Math.round(this.peso / (this.talla * this.talla) * 100) / 100;
    console.log('res_masaCorporal', this.consultaPreocupacional.masaCorporal);

    if (this.consultaPreocupacional.masaCorporal < 18.5) {
      this.consultaPreocupacional.estadoNutricional = "PESO BAJO";
    } else if (this.consultaPreocupacional.masaCorporal >= 18.5 && this.consultaPreocupacional.masaCorporal < 30) {
      this.consultaPreocupacional.estadoNutricional = "PESO NORMAL";
    } else if (this.consultaPreocupacional.masaCorporal >= 30) {
      this.consultaPreocupacional.estadoNutricional = "OBESIDAD";
    }
